...
def show_plot(fig, G):
    global grafo_activo, canvas_picture, canvas, toolbar_widget
    # Añade esta línea para que la variable sea global
    global toolbar_widget
...
def calcular_tiempo():
    ...
    velocidad = simpledialog.askfloat("Velocidad",
                                      ...
                                      minvalue=0.1)
    if velocidad is None:  # Si el usuario cancela
        return

    # Calcular la distancia total sumando los costes de cada segmento
    distancia_total = 0
